...
(function() {
    ...
    const DEBUG_FRIENDLY_FIELD_NAMES_INITIAL = {
        ...
        'SCHEDULER_DETERMINISM' : {
            ...
            'debug[3]':'Gyro Clock Skew [cycles]',
        },
        'TIMING_ACCURACY' : {
        ...
        if (flightLog) {
            ...
            switch (debugModeName) {
                ...
                case 'DSHOT_RPM_TELEMETRY':
                    ...
                    (value * 3.333 / flightLog.getSysConfig()['motor_poles']).toFixed(0) + 'hz';
                case 'RPM_FILTER':
                ...
                case 'RX_TIMING':
                    switch (fieldName) {
                        ...
                        case 'debug[1]': // Frame age us/10
                            return (value / 100).toFixed(2) + 'ms';
                        default:
                            return valuetoFixed(0);
                    }
                case 'GHST':
                    switch (fieldName) {
                        case 'debug[2]': // RSSI 0 to -128 -> 0 to 128
